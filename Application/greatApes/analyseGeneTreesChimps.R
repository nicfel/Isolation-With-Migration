...
trees <- list.files(path="./out/chimp/", pattern="rep9.*\\.trees$", full.names = TRUE)
system("rm -r combined/chimp")
system("mkdir combined/chimp")

system("rm -r mcc/chimp")
system("mkdir mcc/chimp")
# run log combiner
...
log <- list.files(path="./out/chimp/", pattern="rep9.*\\.log$", full.names = TRUE)
# run log combiner
